...
export default function CommunityPage() {
  ...
  return (
  // 1) 제일 바깥: 흰색 배경
  <div className="min-h-screen bg-white flex justify-center p-8">
    {/* 2) 그 다음: 회색 카드 */}
    <div className="w-full max-w-[1200px] bg-gray-100 rounded-3xl p-6">
      {/* 3) 그 다음: 흰색 카드(할 일 찾기 영역 전체) */}
      <div className="bg-white rounded-2xl shadow-sm border p-4">
        <div className="flex gap-4">
          {/* Left Sidebar - Tasks */}
          <div className="flex-[2] bg-white rounded-2xl p-2 overflow-y-auto shadow-sm">
            {/* Header */}
            <div className="mb-6">
              <h1 className="text-2xl font-bold mb-2">할일 찾기</h1>
            ...
            <div className="mb-6">
              <div className="flex flex-wrap gap-2 mb-3">
                ...
                <button className="px-3 py-1.5 border border-gray-200 rounded-md text-sm hover:bg-gray-50">
                  📅 일정
                </button>
                <button className="px-3 py-1.5 border border-gray-200 rounded-md text-sm hover:bg-gray-50">
                  ⭐ 업무등록
          ...
          {/* Right Content - Feed */}
          <div className="flex-[1] bg-white rounded-2xl p-2 overflow-y-auto shadow-sm">
            {/* Header */}
